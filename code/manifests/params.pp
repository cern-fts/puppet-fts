...
class fts::params {
  ...
  $profiling         = hiera('fts3_profiling', '0')
  $msg_broker        = hiera('fts3_msg_broker', 'dashb-mb.cern.ch:6163')
  $msg_username      = hiera('fts3_msg_username','')
  $msg_password      = hiera('fts3_msg_password','')
